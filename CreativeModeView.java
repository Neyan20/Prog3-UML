...
/**
 * Creative Mode brewing screen.
 * Lets the player pick a base and 1-3 fruits to experiment with.
 * A successful combo is added to the Spellbook; a failed combo damages the cauldron.
 *
...
public class CreativeModeView extends JDialog {
    ...
    /**
     * Constructs the creative mode view.
     *
    ...
    /**
     * Builds the base/fruit selection screen.
     */
    ...
    /**
     * Validates the current base/fruit selection and, if confirmed, submits
     * the combo to the controller for brewing.
     */
