...
/**
 * The main menu window of Potion Prodigy.
 * Shows the player's name and crystals, and provides buttons for all 7 game features.
 *
...
public class MainMenuView extends JFrame {
    ...
    /**
     * Handles the exit button - confirms then saves and quits.
     */
    ...
    /**
     * Refreshes the player info labels with current data.
     * Call this after any action that might change crystals or cauldron state.
     */
    public void refresh() {
