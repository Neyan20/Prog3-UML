...
/**
 * The opening screen of Potion Prodigy.
 * Lets the player start a new game or load an existing save.
 *
...
public class OpeningView extends JFrame {
    ...
    /**
     * Makes the opening view visible.
     */
    public void display() {
        setVisible(true);
    }
